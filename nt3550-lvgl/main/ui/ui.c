...
///////////////////// FUNCTIONS ////////////////////
static void ui_event_POS_S1(lv_event_t * e)
{
...
static void ui_event_POS_S2(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SCREEN_LOAD_START) {
...
static void ui_event_BTN_Continue(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_CLICKED) {
...
static void ui_event_POS_S3(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SCREEN_LOAD_START) {
...
static void ui_event_Panel_List_Bg(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_CLICKED) {
...
static void ui_event_POS_S4(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SCREEN_LOAD_START) {
...
static void ui_event_IMG_QR_Code(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_CLICKED) {
...
static void ui_event_Label_Cancel(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_CLICKED) {
...
static void ui_event_POS_S5(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_SCREEN_LOAD_START) {
...
static void ui_event_BTN_Next_2(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_CLICKED) {
...
void ui_POS_S1_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_POS_S1, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_x(ui_IMG_S1_BG, 0);
    lv_obj_set_y(ui_IMG_S1_BG, 0);

    lv_obj_set_align(ui_IMG_S1_BG, LV_ALIGN_TOP_MID);

    lv_obj_add_flag(ui_IMG_S1_BG, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S1_BG, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui_IMG_POS, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_POS, LV_OBJ_FLAG_SCROLLABLE);

    // ui_Label_card_and_crypto

    ui_Label_card_and_crypto = lv_label_create(ui_POS_S1);

    lv_obj_set_width(ui_Label_card_and_crypto, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_card_and_crypto, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_Label_Lets_get, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Lets_get, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_IMG_Arrow, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Arrow, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_IMG_Arrow, 0);
    lv_obj_set_y(ui_IMG_Arrow, 0);

    lv_obj_set_align(ui_IMG_Arrow, LV_ALIGN_CENTER);

    lv_obj_add_flag(ui_IMG_Arrow, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Arrow, LV_OBJ_FLAG_SCROLLABLE);
...
void ui_POS_S2_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_POS_S2, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui_IMG_S2_Bg_1, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S2_Bg_1, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui_IMG_S2_Bg_2, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S2_Bg_2, LV_OBJ_FLAG_SCROLLABLE);

    // ui_Label_Enter_Amount

    ui_Label_Enter_Amount = lv_label_create(ui_POS_S2);

    lv_obj_set_width(ui_Label_Enter_Amount, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Enter_Amount, LV_SIZE_CONTENT);
    ...
    // ui_Label_Want_to_pay

    ui_Label_Want_to_pay = lv_label_create(ui_POS_S2);

    lv_obj_set_width(ui_Label_Want_to_pay, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Want_to_pay, LV_SIZE_CONTENT);
    ...
    lv_obj_clear_flag(ui_Panel_Amount, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Label_Amount_1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Amount_1, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Label_Amount_1, 0);
    lv_obj_set_y(ui_Label_Amount_1, 0);
    ...
    // ui_Label_Amount_Pirce

    ui_Label_Amount_Pirce = lv_label_create(ui_Panel_Amount);

    lv_obj_set_width(ui_Label_Amount_Pirce, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Amount_Pirce, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_Label_Continue, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Continue, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Label_Continue, 0);
    lv_obj_set_y(ui_Label_Continue, 0);
...
void ui_POS_S3_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_POS_S3, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui_IMG_S2_Bg_3, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S2_Bg_3, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui_IMG_S2_Bg_4, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S2_Bg_4, LV_OBJ_FLAG_SCROLLABLE);

    // ui_Label_Select_Payment

    ui_Label_Select_Payment = lv_label_create(ui_POS_S3);

    lv_obj_set_width(ui_Label_Select_Payment, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Select_Payment, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_Label_Ony_BTC, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Ony_BTC, LV_SIZE_CONTENT);
    ...
    lv_obj_clear_flag(ui_Panel_List_BTC, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_x(ui_Panel_List_Bg, 0);
    lv_obj_set_y(ui_Panel_List_Bg, 0);
    ...
    lv_obj_set_width(ui_Panel_BTC_table, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Panel_BTC_table, 18);
    lv_obj_set_y(ui_Panel_BTC_table, -10);

    lv_obj_clear_flag(ui_Panel_BTC_table, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Label_Bitcoin, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Bitcoin, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Label_Bitcoin, 0);
    lv_obj_set_y(ui_Label_Bitcoin, 0);
    ...
    lv_obj_set_width(ui_Label_BTC, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_BTC, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_IMG_BTC, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_BTC, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_BTC, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_BTC, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_IMG_Arrow_List_1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Arrow_List_1, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_Arrow_List_1, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Arrow_List_1, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_clear_flag(ui_Panel_List_ETH, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_x(ui_Panel_List_Bg1, 0);
    lv_obj_set_y(ui_Panel_List_Bg1, 0);
    ...
    lv_obj_set_width(ui_Label_ETH, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_ETH, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_IMG_ETH, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_ETH, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_ETH, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_ETH, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_IMG_Arrow_List_2, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Arrow_List_2, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_Arrow_List_2, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Arrow_List_2, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Panel_ETH_table, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Panel_ETH_table, 18);
    lv_obj_set_y(ui_Panel_ETH_table, -10);

    lv_obj_clear_flag(ui_Panel_ETH_table, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Label_Ethereum, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Ethereum, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Label_Ethereum, 0);
    lv_obj_set_y(ui_Label_Ethereum, 0);
    ...
    lv_obj_clear_flag(ui_Panel_List_XRP, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_x(ui_Panel_List_Bg2, 0);
    lv_obj_set_y(ui_Panel_List_Bg2, 0);
    ...
    lv_obj_set_width(ui_Label_XRP, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_XRP, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_IMG_XRP, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_XRP, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_XRP, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_XRP, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_IMG_Arrow_List_3, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Arrow_List_3, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_Arrow_List_3, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Arrow_List_3, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Panel_XRP_table, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Panel_XRP_table, 18);
    lv_obj_set_y(ui_Panel_XRP_table, -10);

    lv_obj_clear_flag(ui_Panel_XRP_table, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Label_Ripple, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Ripple, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Label_Ripple, 0);
    lv_obj_set_y(ui_Label_Ripple, 0);
    ...
    lv_obj_clear_flag(ui_Panel_List_Card, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_x(ui_Panel_List_Bg3, 0);
    lv_obj_set_y(ui_Panel_List_Bg3, 0);
    ...
    lv_obj_set_width(ui_Label_Card, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Card, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_IMG_XRP1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_XRP1, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_XRP1, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_XRP1, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_IMG_Arrow_List_4, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Arrow_List_4, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_Arrow_List_4, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Arrow_List_4, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Panel_Caed_table, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Panel_Caed_table, 18);
    lv_obj_set_y(ui_Panel_Caed_table, -10);

    lv_obj_clear_flag(ui_Panel_Caed_table, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_Label_Card1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Card1, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_Label_Card1, 0);
    lv_obj_set_y(ui_Label_Card1, 0);
...
void ui_POS_S4_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_POS_S4, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui_IMG_S2_Bg_5, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S2_Bg_5, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_add_flag(ui_IMG_S2_Bg_6, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S2_Bg_6, LV_OBJ_FLAG_SCROLLABLE);

    // ui_Label_Amount_Pirce2

    ui_Label_Amount_Pirce2 = lv_label_create(ui_POS_S4);

    lv_obj_set_width(ui_Label_Amount_Pirce2, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Amount_Pirce2, LV_SIZE_CONTENT);
    ...
    // ui_Label_Amount_Title

    ui_Label_Amount_Title = lv_label_create(ui_POS_S4);

    lv_obj_set_width(ui_Label_Amount_Title, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Amount_Title, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_Label_QR_ready, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_QR_ready, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_IMG_QR_Code, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_QR_Code, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_IMG_QR_Code, 0);
    lv_obj_set_y(ui_IMG_QR_Code, 0);

    lv_obj_set_align(ui_IMG_QR_Code, LV_ALIGN_CENTER);

    lv_obj_add_flag(ui_IMG_QR_Code, LV_OBJ_FLAG_CLICKABLE | LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_QR_Code, LV_OBJ_FLAG_SCROLLABLE);
    ...
    // ui_Label_BTC_Address

    ui_Label_BTC_Address = lv_label_create(ui_POS_S4);

    lv_obj_set_width(ui_Label_BTC_Address, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_BTC_Address, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_Label_Cancel, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Cancel, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_Label_Cancel, LV_OBJ_FLAG_CLICKABLE);
...
void ui_POS_S5_screen_init(void)
{
    ...
    lv_obj_clear_flag(ui_POS_S5, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_x(ui_IMG_S5_BG, 0);
    lv_obj_set_y(ui_IMG_S5_BG, 0);

    lv_obj_set_align(ui_IMG_S5_BG, LV_ALIGN_TOP_MID);

    lv_obj_add_flag(ui_IMG_S5_BG, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_S5_BG, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_IMG_Ok_1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Ok_1, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_Ok_1, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Ok_1, LV_OBJ_FLAG_SCROLLABLE);
    ...
    lv_obj_set_width(ui_IMG_Ok_2, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Ok_2, LV_SIZE_CONTENT);
    ...
    lv_obj_add_flag(ui_IMG_Ok_2, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Ok_2, LV_OBJ_FLAG_SCROLLABLE);

    // ui_Label_Succesful

    ui_Label_Succesful = lv_label_create(ui_POS_S5);

    lv_obj_set_width(ui_Label_Succesful, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_Succesful, LV_SIZE_CONTENT);
    ...
    // ui_Label_press_contimue

    ui_Label_press_contimue = lv_label_create(ui_POS_S5);

    lv_obj_set_width(ui_Label_press_contimue, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_Label_press_contimue, LV_SIZE_CONTENT);
    ...
    lv_obj_set_width(ui_IMG_Arrow1, LV_SIZE_CONTENT);
    lv_obj_set_height(ui_IMG_Arrow1, LV_SIZE_CONTENT);

    lv_obj_set_x(ui_IMG_Arrow1, 0);
    lv_obj_set_y(ui_IMG_Arrow1, 0);

    lv_obj_set_align(ui_IMG_Arrow1, LV_ALIGN_CENTER);

    lv_obj_add_flag(ui_IMG_Arrow1, LV_OBJ_FLAG_ADV_HITTEST);
    lv_obj_clear_flag(ui_IMG_Arrow1, LV_OBJ_FLAG_SCROLLABLE);
