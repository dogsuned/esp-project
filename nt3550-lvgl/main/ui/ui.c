...
void ui_scmain_screen_init(void)
{
    ...
    ui_Calendar = lv_obj_create(ui_scmain);
    lv_obj_set_size(ui_Calendar, 30, 50);  // force: 280
    ...
    lv_label_set_text(ui_lbtitle, "2022/9/23  14:23");
    ...
    lv_obj_add_event_cb(ui_scmain, ui_event_scmain, LV_EVENT_ALL, NULL);
